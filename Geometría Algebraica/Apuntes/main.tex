...
Como premisa supondremos que $k=\overline{k}$.
...
\begin{dem}
    ...
    $x_{i}-a_{i}\in I$, luego $I=(x_{1}-a_{1},\cdots,x_{n}-a_{n})$.
\end{dem}

\noindent De la demostración surge una pregunta, ¿Por que $k[x_{1},\cdots,x_{n}]/I=k$? El siguiente lema lo
responde

\begin{lema}
    Sea $K\subset L$ una extensión de cuerpo tal que $L$ es finitamente generado como $k$-algebra.
    Entonces $L$ es finitamente generado como $k$-módulo.
\end{lema}
