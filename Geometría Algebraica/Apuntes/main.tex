...
\begin{dfn}
    Sea $V\subseteq\A_{k}^{2}$ una curva plana. Dado $p\in V$ decimos que es \textbf{no singular} 
...
\end{dfn}
\begin{dfn}
    Sea $V\subseteq\A_{k}^{2}$ una curva plana. Sea $p=(0,0)$, definimos la multiplicidad de 
    $p=(a,b)$ en $V$ como
    \begin{equation*}
...
\begin{teo}
    Sea $V$ una curva plana irreducible. Entonces $p$ un punto no singular de $V$ si y solo si
