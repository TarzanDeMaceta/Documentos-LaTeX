...
\vspace{1cm}
\noindent\textbf{Problema 1.} Sea $(x_{0},y_{0})$ un cero de $x^{2}-y^{2}$. Demuestre que la recta 
que pasa $(x_{0},y_{0})$ y el origen esta contenida en el conjunto de ceros de $x^{2}-y^{2}$.

\vspace{5mm}
\noindent\textbf{Problema 2.} Muestre que el polinomio $x^{2}-4x+y^{2}-2y-4$ describe una 
circunferencia. Encuentre su radio y centro.

\vspace{5mm}
\noindent\textbf{Problema 3.} Las parábolas descritas por los polinomios $x^{2}-x-4-y$ y 
