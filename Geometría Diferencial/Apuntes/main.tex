...
\noindent esta suma corresponde a la longitudde una curva poligonal que pasa por los puntos $\alpha()t_{i}$.
Si $Q\supseteq P$ es otra partición de $[s,b]$, entonces $L_{a}^{b}(\alpha,Q)\geq L_{a}^{b}
(\alpha,P)$.
